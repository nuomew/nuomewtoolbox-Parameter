...
namespace NyameauToolbox.Editor
{
    public class VRChatAvatarAnalyzer : EditorWindow
    {
        ...
        private void DrawHeader()
        {
            ...
            GUILayout.Label("VRChat模型参数统计 V1.0.1 By.诺喵", EditorStyles.centeredGreyMiniLabel);
        ...
        private void DrawNoAvatarMessage()
        {
            ...
            EditorGUILayout.LabelField("恰饭广告", adTitleStyle);
            ...
            EditorGUILayout.LabelField("150接VRChat模型定制，只改女模型", adContentStyle);
            EditorGUILayout.LabelField("定金30%跑单扣除定金，模型任何bug联系我免费修复", adContentStyle);
            EditorGUILayout.LabelField("模型质保30天，任何衣服物件均可免费添加", adContentStyle);
            EditorGUILayout.LabelField("至止参数256/动骨256/上传最大200/显存最大500/解压最大500为止", adContentStyle);
        ...
        private void DrawOpenSourceDeclaration()
        {
            ...
            GUILayout.Label("本工具基于非商业使用开源协议发布", declarationStyle);
            GUILayout.Label("允许免费使用和查看源代码，但禁止任何商业用途", declarationStyle);
            GUILayout.Label("源代码托管于 GitHub，欢迎非商业性质的贡献和反馈", declarationStyle);
            GUILayout.Label("© 2025 诺喵工具箱 - 仅供非商业免费使用", declarationStyle);
            GUILayout.Label("By.诺喵 QQ:183452584 Discord：nuomew", declarationStyle);
