...
namespace Gatosyocora.MeshDeleterWithTexture.Models
{
    ...
    public class LanguagePack : ScriptableObject
    {
        ...
        // 诺喵工具箱集成相关文本
        public string backToToolboxButtonText = "Back to Toolbox";
        public string androidNotSupportWarningText = "⚠️ Mesh Deleter does not support Android build target\nPlease switch to other platforms to use this tool";
    }
}
